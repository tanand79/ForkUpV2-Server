...
CREATE TABLE IF NOT EXISTS donations (
  ...
  notes TEXT,
  -- Stripe Checkout session id — set when online donation checkout starts.
  stripe_checkout_session_id VARCHAR(255),
  -- Stripe PaymentIntent id — set when payment succeeds (webhook).
...
-- Business → NPO: request to join an existing public campaign (NPO accepts/declines).
...
-- Editable email template library (org / business / fundraiser) with optional
-- per-campaign override. SMTP From address stays platform smtp_from.
