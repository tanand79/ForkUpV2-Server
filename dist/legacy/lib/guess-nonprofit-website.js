    ...
    try {
        const content = await (0, ai_chat_1.aiChat)({
            system: [
                ...
                "Put the best official website URL when you are confident it belongs to this exact organization.",
                "Use https:// when returning a URL.",
                "If unsure, or no public website exists, return {\"website\": \"\"}.",
                "Never invent domains. Do not return social media URLs unless that is the only official presence.",
            ].join("\n"),
