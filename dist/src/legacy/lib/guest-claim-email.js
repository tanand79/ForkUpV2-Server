...
function renderGuestClaimEmail(input) {
    ...
    bodyLines.push(``, `To claim and manage this ${entityLabel} from any device, open the link below:`, claimUrl, ``, `This secure link expires in ${days} days. Please do not forward it — anyone with the link can claim management of this ${entityLabel}.`, ``, `— The ForkUp Team`);
...
//# sourceMappingURL=guest-claim-email.js.map